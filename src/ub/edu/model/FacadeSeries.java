...
public class FacadeSeries {
    ...
    /**
     * Método constructor de FacadeSeries aplicando el patrón Singleton
     */
    ...
    public static FacadeSeries getInstance() {
        if (uniqueInstance == null) {
            synchronized (FacadeSeries.class) {
                if (uniqueInstance == null) uniqueInstance = new FacadeSeries();
            }
        }
     ...
     * @return True si existe, False si no
     */
    public boolean existsSerieWithThisTitle(String titolSerie) { return catalegSeries.existsSerieWithThisTitle(titolSerie); }
     ...
     * @throws Exception si no se dispone de la Serie
     */
    public String getNomSerieByID(String idSerie) throws Exception { return catalegSeries.getNomSerieByID(idSerie); }
    ...
    /**
     * Método para conseguir el número de Episodios que tiene una Serie
