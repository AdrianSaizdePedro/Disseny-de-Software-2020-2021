...
public class DAOValoracioCorMOCK implements DAOValoracioCor {
    ...
    public DAOValoracioCorMOCK() {
        ...
        valoracio_1.add(new CorValoracio(1, "ajaleo", "id1", "bbad", 1,  1,"13.11.2017"));
        valoracio_1.add(new CorValoracio(2, "ajaleo", "id1", "bbad", 1, 2,"13.11.2017"));
        valoracio_1.add(new CorValoracio(3, "ajaleo", "id1", "gofthrones", 1, 1,"17.12.2019"));
        valoracio_1.add(new CorValoracio(4, "ajaleo", "id1", "gofthrones", 2, 1,"20.02.2020"));
        ...
        valoracio_2.add(new CorValoracio(1, "ajaleo", "id2", "bbad", 1, 1,"20.11.2017"));
        valoracio_2.add(new CorValoracio(2, "ajaleo", "id2", "bbad", 1, 2,"20.11.2017"));
        valoracio_2.add(new CorValoracio(3, "ajaleo", "id2", "gofthrones", 1, 1,"20.12.2019"));
        valoracio_2.add(new CorValoracio(4, "ajaleo", "id2", "gofthrones", 2, 1,"20.02.2020"));
        ...
        valoracio_3.add(new CorValoracio(1, "dtomacal", "id4", "bbad", 1, 1,"11.04.2222"));
        valoracio_3.add(new CorValoracio(2, "dtomacal", "id4", "gofthrones", 1, 1,"11.04.2222"));
        valoracio_3.add(new CorValoracio(3, "dtomacal", "id4", "gofthrones", 2, 1,"11.04.2222"));
        ...
        valoracio_4.add(new CorValoracio(1, "chachipistachi", "id7", "bbad", 1, 1,"17.04.2002"));
        valoracio_4.add(new CorValoracio(2, "chachipistachi", "id7", "gofthrones", 1, 1,"17.04.2002"));
        valoracio_4.add(new CorValoracio(3, "chachipistachi", "id7", "gofthrones", 2, 1,"17.04.2002"));
