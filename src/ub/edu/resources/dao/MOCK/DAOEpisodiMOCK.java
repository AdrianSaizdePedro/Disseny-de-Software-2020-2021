...
public class DAOEpisodiMOCK implements DAOEpisodi {
    ...
    public DAOEpisodiMOCK() {
        ...
        episodis_GameOfThrones.add(new Episodi("gofthrones", "Game of Thrones",1 , 1, "Winter Is Coming", "65:13:00", "VOSE",   "El rey Robert Baratheon de Poniente viaja al Norte para ofrecerle a su viejo amigo Ned Stark, GuardiȮ del Norte y Ser de Invernalia, el puesto de Mano del Rey", "17/04/2011"));
        episodis_GameOfThrones.add(new Episodi("gofthrones", "Game of Thrones",1 , 2, "The Kingsroad","60:00:00", "VOSE", "Tras aceptar su nuevo rol como Mano del Rey, Ned parte hacia Desembarco del Rey con sus hijas Sansa y Arya", "24/04/2011"));
        episodis_GameOfThrones.add(new Episodi("gofthrones", "Game of Thrones",1 , 3, "Lord Snow","61:00:00", "VOSE","Ned se une al Consejo Privado del Rey en Desembarco del Rey","01/05/2011"));

        // Episodis para Temporada 2 de la Serie Breaking Bad
        episodis_GameOfThrones.add(new Episodi("gofthrones", "Game of Thrones",2 , 1, "The north remembers", "45:15:00", "VOSE",   "Tyrion llega para salvar la corona de Joffrey", "01/04/2012"));
        episodis_GameOfThrones.add(new Episodi("gofthrones", "Game of Thrones",2 , 2, "The Night Lands","60:00:00", "VOSE","Arya comparte un secreto con un recluta familiar" , "08/04/2012"));
        episodis_GameOfThrones.add(new Episodi("gofthrones", "Game of Thrones",2 , 3, "What is dead may never die","61:00:00", "VOSE","Tyrion desenmascara...","15/05/2012"));
        ...
        episodis_GameOfThrones.add(new Episodi("gofthrones", "Game of Thrones",3 , 2, "Dark wings","55:00:00", "VOSE","Walt tiene problemas ajustȮdose a su nueva vida. Se niega a seguir manufacturando el producto." , "27/01/2008"));
        episodis_GameOfThrones.add(new Episodi("gofthrones", "Game of Thrones",3 , 3, "Walk of punishment","55:00:00", "VOSE","Walt regresa a su casa y le dice a Skyler que no tiene intenciخ de irse, Walter Jr. se alegra de saber que su padre estǠde vuelta.","10/02/2008"));
        ...
        episodis_MrRobot.add(new Episodi("mrobot", "Mr Robot",1 , 1, "eps1.0_hellofriend.mov", "45:00:00", "ES",   "Elliot Alderson trabaja en Allsafe, una empresa de seguridad informȴica.", "24/06/2015"));
        episodis_MrRobot.add(new Episodi("mrobot", "Mr Robot",1 , 2, "Hey, ¿Que pasa?","60:00:00", "ES", "Walt tiene problemas ajustȮdose a su nueva vida. Se niega a seguir manufacturando el producto.", "01/07/2015"));
        episodis_MrRobot.add(new Episodi("mrobot", "Mr Robot",1 , 3, "Marvel >> DC","61:00:00", "ES","Tyrell pega una paliza a un mendigo para liberar estrϳ.","08/07/2015"));
        ...
        episodis_Strangerthings.add(new Episodi("sthings", "Stranger Things",1 , 2, "Episodio 2: Stranger Things","60:00:00", "ES", "Elliott rechaza una bien remunerada oferta de trabajo ofrecida por", "01/07/2015"));
        episodis_Strangerthings.add(new Episodi("sthings", "Stranger Things",1 , 3, "Episodio 3: Stranger Things","61:00:00", "ES","Tyrell pega una paliza a un mendigo para liberar estrϳ.","08/07/2015"));
        ...
        episodis_RickYMorty.add(new Episodi("RyM", "Rick y Morty",1 , 2, "Episodio 2: Rick Y Morty","60:00:00", "ES", "Elliott rechaza una bien remunerada oferta de trabajo ofrecida por", "01/07/2015"));
        episodis_RickYMorty.add(new Episodi("RyM", "Rick y Morty",1 , 3, "Episodio 3: Rick Y Morty","61:00:00", "ES","Tyrell pega una paliza a un mendigo para liberar estrϳ.","08/07/2015"));
